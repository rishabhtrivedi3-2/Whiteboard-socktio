    ...
    return (
        <>
            ...
            <div className="container mx-auto md:text-4xl">
                <div className="border-3 border-green flex flex-wrap justify-evenly shadow-md rounded-md items-center w-auto">
                    ...
                    <div className="flex flex-row justify-center space-x-3">
                        ...
                        <button
                            className="border bg-red-600/90 rounded-2xl ring-1 py-1 px-2 text-white"
                            onClick={ClickUndo}
                        >
                            <svg
